...
mongoose.connect(
  "mongodb+srv://ayeshaaxshaikh:qYdjFYAVCJaqTQwu@cluster0.aniat.mongodb.net/e-commerce"
);
...
app.post("/upload", upload.single("product"), (req, res) => {
  res.json({
    success: 1,
    image_url: `https://e-commerce-cllq.onrender.com/images/${req.file.filename}`,
  });
});
